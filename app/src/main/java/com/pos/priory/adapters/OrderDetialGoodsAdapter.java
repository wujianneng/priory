...
public class OrderDetialGoodsAdapter extends BaseMultiItemQuickAdapter<OrderBean.ItemsBean, BaseViewHolder> {
    public int operatingStatus = 0;
    Context context;


    public OrderDetialGoodsAdapter(List<OrderBean.ItemsBean> data, Context context) {
        super(data);
